...
def main():
    ...
    if args.model == "cResNet":
        ...
        net = cResNet_42({'data': latent_batch[0]}, is_training=args.is_training, num_classes=args.num_classes)
        ...
        net = cResNet_39_hyper2({'y_hat': latent_batch[0], 'sigma_hat': latent_batch[1]}, is_training=args.is_training, num_classes=args.num_classes)
    elif args.model == "cResNet39-h3":
        net = cResNet_39_hyper3({'y_hat': latent_batch[0], 'sigma_hat': latent_batch[1]}, is_training=args.is_training, num_classes=args.num_classes)
    else:
    ...
    saver = tf.train.Saver(var_list=tf.global_variables(), max_to_keep=24)
